...
# 移除要替换的包
rm -rf feeds/kiddin9/{shadowsocksr-libev,shadowsocks-rust,luci-app-ssr-plus,luci-i18n-ssr-plus-zh-cn,luci-app-ssr-plus,luci-i18n-ssr-plus-zh-cn,luci-app-wol,luci-app-bypass}
...
#rm -rf feeds/kiddin9/luci-i18n-ssr-plus-zh-cn
...
cp -r feeds/kiddin9/xray-core feeds/packages/net
cp -r feeds/kiddin9/mosdns feeds/packages/net
cp -r feeds/kiddin9/v2ray-geodata feeds/packages/net
cp -r feeds/kiddin9/v2ray-geoip feeds/packages/net
cp -r feeds/kiddin9/sing-box feeds/packages/net
cp -r feeds/kiddin9/chinadns-ng feeds/packages/net
cp -r feeds/kiddin9/dns2socks feeds/packages/net
...
cp -r feeds/kiddin9/luci-app-passwall feeds/luci/applications/luci-app-passwall
cp -r feeds/kiddin9/luci-app-openclash feeds/luci/applications/luci-app-openclash
...
#cp -af feeds/kiddin9/luci-app-passwall/*  feeds/luci/applications/luci-app-passwall/

#rm -rf feeds/luci/applications/luci-app-openclash/*
#cp -af feeds/kiddin9/luci-app-openclash/*  feeds/luci/applications/luci-app-openclash/
